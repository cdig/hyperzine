...
Take(["Env", "MainState"], function(Env, MainState) {
  ...
  defaultWindow = {
    ...
    titleBarOverlay: Env.isMac ? false : {
      color: nativeTheme.shouldUseDarkColors ? "#1b1b1b" : "#f2f2f2",
